  ...
  return (
    <main className="relative flex h-screen w-full flex-col items-center justify-center gap-y-8 overflow-hidden bg-[url('/Images/gettingStarted/background.png')] bg-cover bg-center px-6 py-12">
      ...
      <section className="z-10">
        <h1 className="text-xl lg:text-4xl xl:text-5xl md:text-4xl text-center text-white font-bold mt-20">
      ...
      <section className='z-10 flex w-full max-w-4xl flex-col items-center justify-center gap-6 px-4 md:px-0'>
        ...
        >
          ...
          <Image
            ...
            width={200} 
            height={200} 
            className="absolute bottom-2 rounded-r-4xl right-5 w-[120px] h-auto md:w-[300px] lg:w-[280px] 2xl:w-[350px] max-w-full"
            priority 
            draggable={false}
          />
        </article>
      ...
      <Image
        ...
        className="absolute bottom-0 left-0 z-0 md:z-10 w-[250px] h-auto md:w-[300px] lg:w-[400px] xl:w-[500px] md:h-[400px] lg:h-[500px] xl:h-[600px] 2xl:left-20 xl:left-10 md:left-0 max-w-full"
        priority 
        draggable={false}
      />
        ...
        {isModalOpen && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={closeModal}
                className='mb-4 cursor-pointer text-base font-bold text-red-500 bg-transparent border-0'
                aria-label="Cancel"
                type="button"
              >
                Cancel
