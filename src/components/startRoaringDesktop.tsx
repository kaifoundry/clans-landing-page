  ...
  ({
    ...
    return (
      <main className="relative flex h-screen w-full flex-col items-center justify-center gap-y-8 overflow-hidden bg-[url('/Images/gettingStarted/background.png')] bg-cover bg-center px-6 py-12">
        {/* Clan Logo */}
        <header className='xs:w-16 xs:h-16 absolute top-10 left-10 h-14 w-14 transition-all duration-300 ease-in-out sm:h-20 sm:w-20 md:h-24 md:w-24 lg2:h-32 lg2:w-32 xl:h-40 xl:w-40 2xl:h-48 2xl:w-48'>
          <ClanLogo />
        </header>

        {/* Page Title */}
        <section className='z-10'>
          <h1 className='mt-20 text-center text-xl font-bold text-white md:text-4xl lg1:text-4xl xl:text-5xl'>
        ...
        <section className='z-10 flex w-full max-w-4xl flex-col items-center justify-center gap-6 px-4 md:px-0'>
          <article
            className='relative flex w-full flex-col items-center justify-center rounded px-10 py-8 md:gap-5 lg:h-[400px] lg:w-[700px] lg2:h-[530px] lg2:w-[958px] lg2:gap-12'
            style={{
          ...
          >
            ...
            <Image
              ...
              width={200}
              height={200}
              className='absolute right-5 bottom-2 md:right-4 md:bottom-3 lg2:right-5 lg2:bottom-2 h-auto w-[120px] max-w-full rounded-r-4xl md:w-[230px] lg2:w-[300px] 2xl:w-[350px]'
              priority
              draggable={false}
            />
          </article>
        ...
        <Image
          ...
          className='absolute bottom-0 left-0 z-0 h-auto w-[250px] max-w-full md:left-0 md:z-10 md:h-[400px] md:w-[300px] lg2:h-[500px] lg2:w-[400px] xl:left-10 xl:h-[600px] xl:w-[500px] 2xl:left-20'
          priority
          draggable={false}
        />
