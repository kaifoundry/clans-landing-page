    ...
    return (
      <main className="relative flex h-screen w-full flex-col items-center justify-center gap-y-8 overflow-hidden bg-[url('/Images/gettingStarted/background.png')] bg-cover bg-center px-6 py-12">
        ...
        <section className='z-10 flex w-full max-w-4xl flex-col items-center justify-center gap-6 px-4 md:px-0'>
          ...
          >
            ...
            <div className='flex h-full flex-col items-center justify-center'>
              <p className='text-center text-lg leading-8 text-white md:text-xl md:leading-10 xl:text-2xl xl2:text-2xl'>
        ...
        <Image
          ...
          className='lg2:h-[500px] lg2:w-[400px] absolute bottom-0 left-0 z-0 h-auto w-[250px] max-w-full md:left-0 md:z-10 md:h-[400px] md:w-[300px] xl:left-10 xl:h-[600px] xl:w-[430px] xl2:w-[500px] 2xl:left-20'
          priority
          draggable={false}
        />
