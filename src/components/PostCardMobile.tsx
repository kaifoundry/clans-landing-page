...
const PostClanCardMobile = forwardRef<HTMLDivElement, ClanCardProps>(
  (
    {
      title,
      description,
    ...
    return (
      <div
        ref={ref}
        className="relative flex items-center h-[275px] sm:h-[315px] justify-center rounded-3xl border-2 bg-[url('/Images/cardPage/cardBg.png')] shadow-2xl"
        style={{
          width: '317px',
          // height: '315px',
          maxWidth: '95vw',
...
PostClanCardMobile.displayName = 'PostClanCardMobile';

export default PostClanCardMobile;
